...
// * Method: Decompose poly into triangles "shatter"
// * Investigate further the delays caused by buffer expansion
// * Investigate alternative video card arrays;
//	iPad implementation seems to run slow
...
Kiwi.Renderers.PrimitiveRenderer.prototype.addToBatch =
	...
	for ( i = 0; i < triLen; i++ ) {
		...
		this._vertexBuffer.items.push(
			p0.x, p0.y,
			col[ 0 ], col[ 1 ], col[ 2 ], entity.alpha,
			p1.x, p1.y,
			col[ 0 ], col[ 1 ], col[ 2 ], entity.alpha,
			p2.x, p2.y,
			col[ 0 ], col[ 1 ], col[ 2 ], entity.alpha );
