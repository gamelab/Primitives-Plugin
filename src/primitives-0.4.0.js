...
* @param params.strokeColor {array} RGB normalized color
* @param params.strokeWidth {number} Width of stroke in pixels
...
Kiwi.Plugins.Primitives.Polygon.prototype.parseParams = function( params ) {
	...
	// These must be defined after base vertices and in unique order
...
* @param params.centerOnTransform {boolean} If true, ellipse is centered
*	on transform; default false, ellipse has top left corner on transform
* @param params.height {number} Height of the ellipse, default 8
* @param params.radius {number} Radius of a circle; overide width and height
* @param params.radiusPointer {boolean} Whether to draw the radius, useful
*	for debugging rotation on circles. Default false.
* @param params.segments {number} Number of radial segments; detail. Default 32.
* @param params.state {Kiwi.State} Current state; non-optional
* @param params.width {number} Width of the ellipse, default 8
* @since 0.4.0
*/
...
* @namespace Kiwi.Plugins.Primitives
* @param params {object} Parameter object
* @param params.centerOnTransform {boolean} If true, rectangle is centered
*	on transform; if false, rectangle has top left corner on transform
* @param params.height {number} Height of the rectangle, default 8
* @param params.state {Kiwi.State} Current state; non-optional
* @param params.width {number} Width of the rectangle, default 8
* @since 0.4.0
*/
...
* @namespace Kiwi.Plugins.Primitives
* @param params {object} Parameter object
* @param params.centerOnTransform {boolean} If true, star is centered
*	on transform; if false (default), star has top left corner on transform
* @param params.height {number} Height of the star, default 8
* @param params.spikeLength {number} Length of star spikes relative to radius,
*	default 1
* @param params.spikeRandom {number} Randomness of star spikes, where 0 is
*	default (no randomness) and 1 will make some spikes up to twice as long;
*	there is no cap.
* @param params.radius {number} Radius of a star; overide width and height
* @param params.segments {number} Number of points, default 32
* @param params.state {Kiwi.State} Current state; non-optional
* @param params.width {number} Width of the star, default 8
* @since 0.4.0
*/
